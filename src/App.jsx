            ...
            <div onClick={(e) => e.stopPropagation()} className="bg-card border-bordo shadow-ombra w-full flex flex-col gap-8 justify-between p-4 md:w-150 h-100 z-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 shadow-lg rounded-md">
              ...
              <div className="flex items-center gap-10">
                ...
                <button
                  ...
                  className={`${isDark ? 'bg-gray-500' : 'bg-gray-100'} w-20 h-9 flex items-center rounded-full p-1 transition-colors duration-300`}
                >

                  {/* Peer */}
                  <div
                    className={`w-8 h-8 flex items-center justify-center rounded-full transition-transform duration-500 shadow-sm ${
                      isDark ? 'translate-x-10 bg-gray-700 text-white rotate-360' : 'translate-x-0 bg-white text-yellow-400'
                    }`}
                  >
