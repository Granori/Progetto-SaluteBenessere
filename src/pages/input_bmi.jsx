    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr] items-center gap-x-2 gap-y-1.5">
            ...
            <input
                id={id}
                {...props}
                className={`w-full sm:w-48 px-5 py-4 border-2 rounded-xl outline-none transition-all font-bold text-lg placeholder:text-slate-300 
                ${error
            ...
            {error && (
                <div className="sm:col-start-2 px-2 text-red-500 text-xs font-bold uppercase tracking-wider animate-pulse">
                {error}
                </div>
            )}
        </div>
