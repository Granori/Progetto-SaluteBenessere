    ...
    return (
        <nav className="w-full bg-white border-b border-slate-200 px-10 py-5 items-center shadow-sm">
            <div className="flex justify-between">
                ...
                <div className="flex items-center gap-10">
                    ...
                    <div className="md:hidden">
                        <button onClick={ toggleHamburger } className="text-slate-600 focus:outline-none cursor-pointer">
                    ...
                    <div className="">
                        <svg onClick={ toggleProfilo } xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="size-8 cursor-pointer">
            ...
            <div className={`${isOpenProfilo ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'} grid transition-[grid-template-rows,opacity] duration-300 ease-in-out`}>
                <div className="overflow-hidden bg-white">
                    <div className="px-4 border-b border-slate-200 py-4 space-y-2">
                        <div className="flex flex-col gap-6 md:gap-8 text-sm font-bold uppercase tracking-widest text-slate-500">
                            <NavLink to='/login'
                                className="cursor-pointer hover:border-b-2 hover:border-emerald-600 hover:text-emerald-500 transition">
                                Accedi
                            </NavLink>
                            <div onClick={() => setIsOpenImp(!isOpenImp)} className="cursor-pointer hover:border-b-2 hover:border-emerald-600 hover:text-emerald-500 transition">
                                Impostazioni
                            </div>
                        </div>
